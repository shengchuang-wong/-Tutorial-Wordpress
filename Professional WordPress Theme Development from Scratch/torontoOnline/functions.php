<?php
    function torontoOnline_scripts() {
        ...
        wp_enqueue_script('bxsliderjs', get_stylesheet_directory_uri().'/js/jquery.bxslider.js', array('jquery'), '3.3', true); 
        // true is execute the script in bottom of the page
    ...
    // add menu settings in admin dashboard
