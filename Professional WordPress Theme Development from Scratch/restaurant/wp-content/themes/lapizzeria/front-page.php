<?php get_header(); // will get the header.php ?>
    ...
    <div class="main-content container">
        <main class="container-grid clear">
            <h2 class="primary text-center">Our Specialties</h2>
            <?php
                $args = array(
                    'posts_per_page' => 3,
            ...
            <div class="container-grid">
                <?php while(have_posts()): the_post(); ?>
                    <div class="columns2-4">
                        <h3><?php the_field('fresh_ingredientst_title') ?></h3>
                        <?php the_field('fresh_ingredients_text') ?>
                        <?php $url = get_page_by_title('About Us'); ?>
                        <a class="button primary" href="<?php echo get_permalink($url->ID) ?>">more info</a>
                    </div>
...
<?php get_footer(); // will get the footer.php ?>
